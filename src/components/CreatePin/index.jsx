    ...
    return (
        <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
            ...
            <div className="flex lg:flex-col flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full ">
                    ...
                    <div className="flex flex-col justify-center border-2 border-dotted border-gray-300 p-3 w-full h-420 ">
                        ...
                        {!imageAsset ? (
                            <label>
                                <div className="flex flex-col justify-center items-center h-full cursor-pointer">
                                    ...
                                    <p className="mt-32 text-gray-400">
                                        Recomendation: use high-quality image (SVG, PNG, JPG, WEBPG){" "}
                                    </p>
                                </div>
                            ...
                            <div className="relative h-full">
                                <img src={imageAsset?.url} alt="upload" className="object-contain w-full h-full" />
                                <button
                                    type="button"
                                    className="absolute bottom-3 right-3 p-3 rounded-full bg-white text-xl cursor-pointer outline-none opactity-50 hover:bg-black hover:text-white hover:shadow-md transition-all duration-500 ease-in-out"
                ...
                <div className="flex flex-2 flex-col  gap-6 lg:pl-5 mt-5 w-full">
                    <input
                        type="text"
                        value={title}
                        onChange={e => setTitle(e.target.value)}
                        placeholder="Add your title there..."
                        className="outline-none text-2xl sm:text-3xl font-bold border-b-2 border-gray-300 p-2"
                    />

                    {user && (
                        <div className="flex gap-2 my-2 items-center bg-white rounded-lg">
                            <img src={user.image} className="w-10 h-10 rounded-full" alt="user-profile image" />
                    ...
                    <input
                        ...
                        placeholder="What's you destination link?"
                        className="outline-none text-base sm:text-lg border-b-2 border-gray-300 p-2"
                    />
