                        ...
                        <div className="flex justify-between items-center">
                            <div className="flex gap-2">
                                <a
                                    ...
                                    className="bg-white w-9 h-9 flex items-center justify-center text-dark text-xl opacity-75 hover:opacity-100 hover:shadow-md outline-none rounded-full"
                                >
                        ...
                        <div className="flex justify-between items-center gap-2 w-full">
                            {destination && (
                                <a href={destination}
                                    target="_blank"
                                    rel="noreferrer"
                                    className="bg-white flex items-center justify-center gap-2 text-black font-bold p-2 pl-4 pr-4 rounded-full opactity-70 hover:opacity-100 hover:shadow-md outline-none"
                                ><BsFillArrowUpRightCircleFill />{destination.length > 20 ? destination.slice(8, 20) : destination.slice(8)}</a>
                            )}
